...
#define STRING_CONFIG_H_AUTHOR "(INESC MN)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "INKY"
...
#define HEATER_3_MAXTEMP 90
#define HEATER_4_MAXTEMP 90
...
#define EXTRUDE_MAXLENGTH 99999
...
/**
   ...
   Override with M203
                                        X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
*/
#define DEFAULT_MAX_FEEDRATE          { 80, 80 , 5, 80 }
...
//#define MANUAL_X_HOME_POS 72
//#define MANUAL_Y_HOME_POS 118
...
#define Z_SAFE_HOMING_X_POINT (72)   // X point for Z homing when homing all axes (G28).
#define Z_SAFE_HOMING_Y_POINT (42)    // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY 800
