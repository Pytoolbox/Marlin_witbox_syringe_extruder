...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {40*60, 40*60, 5*60, 60}  // Feedrates for manual moves along X, Y, Z, E from panel
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_2 "BLTouch Alarm"
  #define USER_GCODE_2 "M280 P0 S160\nG4 P100"
